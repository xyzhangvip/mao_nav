  ...
  <div v-else class="nav-home">
    ...
    <aside class="sidebar">
      ...
      <div class="logo-section">
        ...
        <h1 class="site-title">{{ title || 'Zhang的导航' }}</h1>
      </div>
      ...
      <div class="sidebar-footer">
        <a
          href="https://github.com/xyzhangvip/mao_nav"
          target="_blank"
        ...
        <div v-else class="categories-container">
          ...
          <footer class="page-footer" hidden="true">
            ...
            <div class="footer-bottom">
              <p>&copy; {{ new Date().getFullYear() }} Zhang的导航 - 由 <a href="https://github.com/xyzhangvip" target="_blank" rel="noopener noreferrer">maodeyu180</a> 用 ❤️ 制作</p>
              <p class="footer-tech">基于 Vue.js 构建 | <a href="https://github.com/xyzhangvip/mao_nav" target="_blank" rel="noopener noreferrer">查看源代码</a></p>
            </div>
          </footer>
        </div>
      </div>
